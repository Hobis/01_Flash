...
package hb.utils
{
	...
	public final class MovieClipUtil
	{
		...
		// :: 무비클립 기본 롤오버아웃 등록해제
		public static function removeRoo(target:MovieClip):void
		{
		...
		// :: 무비클립 기본 롤오버아웃 등록하기
		public static function addRoo(target:MovieClip):void
		{
		...
		// :: 무비클립 콜백 호출
		public static function dispatchCallBack(target:MovieClip, eventObj:Object):void
		{
		...
		public static function getLabelCount(target:MovieClip, keyword:String):uint
		{
			var t_rv:uint = 0;
		...
		// :: 프래임라벨로 프래임번호 알아내기
		public static function getLabelToFrame(target:MovieClip, name:String):int
		{
			var t_rv:int = -1;
...
/*
				if (t_mc.$d_acps != null)
					t_mc.$d_ac.apply(null, t_mc.$d_acps);
				else
					t_mc.$d_ac();
